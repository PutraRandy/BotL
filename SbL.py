...
cl = LINETCR.LINE()
cl.login(token="Eq0RcnSt0MO4k54n3As2.3KbbFFx19COHouryikaIGG.vxUy/w1SG1ZEOdNqfMXpygbv/+gICiJK0RoQtvdQoac=")
cl.loginResult()
...
Bots=["ude40417df5f5f5ca2139445820a02282"]
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["anu Lagi Off Kalau Penting Pc Aja",cName + " tag mulu jones?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Leo Nya lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,keypro)
                else:
                    cl.sendText(msg.to,keypro)
            elif msg.text.lower() == 'key4':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,keyself)
                else:
                    cl.sendText(msg.to,keyself)
            elif msg.text.lower() == 'key3':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,keygrup)
                else:
                    cl.sendText(msg.to,keygrup)
            elif msg.text.lower() == 'key2':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,keyset)
                else:
                    cl.sendText(msg.to,keyset)
            elif msg.text.lower() == 'key1':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,keymed)
                else:
                    cl.sendText(msg.to,keymed)
...
#========================== B O T ``C O M M A N D =============================#
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"contact sukses on")
                    else:
                ...
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Leave room on")
                    else:
                ...
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto Leave room off")
                    else:
                ...
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Share sukses on")
                    else:
                ...
                if wait["timeline"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Share di off")
                    else:
                ...
                cl.sendText(msg.to,"₱øw€rëđ Bÿ TēāmBøtÅđhï [T-B-Ä]")
                ...
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto add to on")
                    else:
                ...
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Auto add to off")
                    else:
...
#==============================================================================#
                ...
                if wait["Wc"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ñötï₣ yg joιn poto on")
                else:
                    wait["Wc"] = True
                    if wait["lang"] == "JP":
                ...
                if wait["Wc"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Ñøtî₣ joιn poto off")
                else:
                    wait["Wc"] = False
                    if wait["lang"] == "JP":
...
#=============================================================================#
            ...
            elif msg.text in ["Rfoto on","respon foto on"]:
                wait['potoMention'] = True
                cl.sendText(msg.to,"Auto respon tag poto On")

            elif msg.text in ["Refoto off","respon foto off"]:
...
#==============================================================================#
                ...
                if msg.to in wait2['readPoint']:
                        ...
                        with open('sider.json', 'w') as fp:
                         ...
                         cl.sendText(msg.to,"Intip already on")
                else:
                    try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#======================================================================#
                    ...
                    wait["Sider"] == True
                    cl.sendText(msg.to,"¢€k §ïđ€r øñ Bō§§..!!!")

            elif msg.text in ["Sider off","sider off"]:
                    if msg.to in cctv['point']:
                        cctv['cyduk'][msg.to]=False
                        wait["Sider"] = False
                        cl.sendText(msg.to,"Ć€k §ïđ€ Ø₣₣ Bøš§")
                    else:
                        cl.sendText(msg.to,"Bë₤ùm Đī §ēt Bø§qû")
#============================================================================#
...
#==============================================#
        ...
        if op.type == 17:
            if wait["Wc"] == True:
                ...
                cl.sendText(op.param1, "Welcome kakak jangan lupa nikung ya : \n Semoga betah ya kak")
        ...
        if op.type == 15:
            if wait["Lv"] == True:
                if op.param2 in Bots:
                    return
                cl.sendText(op.param1, "Baper Tuh Orang :v \n║Semoga Bahagia ya Jangan lupa bojonya ketinggallan")
                cl.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net/" + h.pictureStatus)
