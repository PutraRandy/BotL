...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {'X-Line-Application':'DESKTOPMAC 8.2.2  12.0.2','X-Line-Access': self.authToken, 'User-Agent': 'Line/2018.07332.2233.Tanduri/760.1.6 Tanysyz/18.0.0'}
    self.cert = self.Talk.cert
    self._headers = {
              'X-Line-Application': 'DESKTOPMAC 8.2.2  ',
